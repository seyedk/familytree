...
/**
 * This class dumps a family tree to a destination (for example, a file) in a
 * text-based format that is meant to be parsed by a TextParser. It is not
 * necessarily human-readable.
 * 
 * @see TextParser
 * 
 * @author Seyed Ketabchi
 */
public class TextDumper implements Dumper {

	/**
	 * Test program. Create a simple family tree and dump it to the file specified
	...
	/**
	 * Creates a new text dumper that prints to a <code>PrintWriter</code>. This
	 * way, we can dump to destinations other than files.
	 */
	...
	/**
	 * Creates a new text dumper that dumps to a file of a given name. If the file
