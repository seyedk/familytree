...
import org.seyedk.lnl.domain.Person.Gender;
...
public class AddPerson {
	...
	/**
	 * Main program that parsers the command line and adds a person to a family
	 * tree.
	 * 
	 * @throws IOException
	 */
	public static void main(String[] args) throws IOException {
		...
		if (childId != 0) {
			...
			if (child == null) {
				String s = "The child with id " + childId + " does not exist";
				err.println("\n** " + s + "\n");
				System.exit(1);
			}
	 ...
	 * 
	 * @return An error message if the command line was not parsed sucessfully
	 */
