...
/**
 * This class contains fields and methods that are useful when dealing with XML
 * data.
 */
class XmlHelper implements EntityResolver, ErrorHandler {

	/** The Public ID for the Family Tree DTD */
	protected static final String publicID = "-//Portland State University//DTD CS410J Family Tree//EN";
	...
	public void error(SAXParseException ex) throws SAXException {
		String s = "Error while parsing XML (" + ex.getLineNumber() + ":" + ex.getColumnNumber() + "): "
				+ ex.getMessage();
	...
	public void fatalError(SAXParseException ex) throws SAXException {
		String s = "Fatal error while parsing XML (" + ex.getLineNumber() + ":" + ex.getColumnNumber() + "): "
				+ ex.getMessage();
		throw new SAXException(s);
	}
	...
	/**
	 * Attempt to resolve the external entity (such as a DTD) described by the given
	 * public and system ID. The external entity is returned as a
	...
	public void warning(SAXParseException ex) throws SAXException {
		String s = "Warning while parsing XML (" + ex.getLineNumber() + ":" + ex.getColumnNumber() + "): "
				+ ex.getMessage();
