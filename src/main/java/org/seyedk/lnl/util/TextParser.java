...
/**
 * This class parses the text output generated by a <code>TextDumper</code> and
...
public class TextParser implements Parser {
	...
	/**
	 * Test program. Parse the file that is given on the command line. Pretty print
	...
	/**
	 * Creates a new text parser that reads its input from the given writer. This
	 * lets us read from a sources other than files.
	 */
	 ...
	 * 
	 * @throws FamilyTreeException The data source is malformatted
	 */
	@Override
	...
	/**
	 * Helper method that parses the source, creates a <code>Person</code>, and adds
	 * it to the family tree.
	 */
